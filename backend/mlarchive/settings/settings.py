...
for storagename in ARTIFACT_STORAGE_NAMES:
    ...
    STORAGES[replica_storagename] = {
        ...
        "OPTIONS": dict(
            endpoint_url=BLOB_STORE_ENDPOINT_URL,
            access_key=BLOB_STORE_ACCESS_KEY,
            secret_key=BLOB_STORE_SECRET_KEY,
            security_token=None,
            ...
            verify=False,
            bucket_name=f"{BLOB_STORE_BUCKET_PREFIX}{storagename}".strip(),
            ietf_log_blob_timing=BLOB_STORE_ENABLE_PROFILING,
        ),
    }
