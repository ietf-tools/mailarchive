    ...
    def update(self, index, iterable, commit=True):
        ...
        try:
            ...
            def add_text(termpos, prefix, text, weight):
                ...
                if len(term.split()) == 1 and len(term) < 240:
            ...
            for obj in iterable:
                ...
                # AMS custom: we don't need full message text in data section of index
                del data['text']
                # end custom
                ...
                # AMS custom: capture xapian.InvalidArgumentError, when garbage is > 245 chars
                try:
                    database.replace_document(document_id, document)
