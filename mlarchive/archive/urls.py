...
urlpatterns = [
    ...
    url(r'^browse/static/(?P<list_name>[a-z0-9_\-\+\.]+)/(?P<prefix>|thread)/?$', views.browse_static_redirect, name='archive_browse_static'),
    url(r'^browse/static/(?P<list_name>[a-z0-9_\-\+\.]+)/(?P<prefix>|thread)(?P<date>\d{4}(-\d{2})?)/$', views.browse_static, name='archive_browse_static_date'),
